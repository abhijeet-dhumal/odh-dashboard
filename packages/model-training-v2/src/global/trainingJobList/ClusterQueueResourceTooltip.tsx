    ...
    >
      ...
      >
        <div style={{ marginBottom: '4px', color: '#ffffff' }}>
          <strong style={{ color: '#e0e0e0' }}>Queue:</strong>{' '}
          {clusterQueue.metadata?.name || 'Unknown'}
        </div>
        <div style={{ fontSize: '13px', color: '#ffffff' }}>
          <div style={{ marginBottom: '2px' }}>
            <strong style={{ color: '#e0e0e0' }}>Pending:</strong>{' '}
            <span style={{ color: '#ffa500' }}>{clusterQueue.status?.pendingWorkloads ?? 0}</span>
          </div>
          <div>
            <strong style={{ color: '#e0e0e0' }}>Admitted:</strong>{' '}
            <span style={{ color: '#92d400' }}>{clusterQueue.status?.admittedWorkloads ?? 0}</span>
          </div>
        </div>
      </div>
