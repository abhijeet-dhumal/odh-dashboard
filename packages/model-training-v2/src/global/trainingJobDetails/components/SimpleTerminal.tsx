...
import { Card, CardBody, EmptyState, EmptyStateBody, Title } from '@patternfly/react-core';
...
const SimpleTerminal: React.FC<SimpleTerminalProps> = ({
      ...
      <Card isFullHeight>
        <CardBody>
          <EmptyState>
            ...
            <EmptyStateBody>Select a container to view terminal.</EmptyStateBody>
          </EmptyState>
        </CardBody>
      </Card>
    );
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ color: '#ffffff', marginBottom: '8px' }}>sh-4.4$ ls /workspace</div>
        <div style={{ color: '#cccccc', marginBottom: '12px' }}>
          checkpoints/ trl-training.py cache/ logs/ dataset/
        </div>
        <div style={{ color: '#ffffff', marginBottom: '8px' }}>sh-4.4$ ps aux | grep python</div>
        <div style={{ color: '#cccccc', marginBottom: '12px' }}>
