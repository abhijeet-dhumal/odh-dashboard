...
const ModelTraining = (): React.ReactElement => {
  ...
  return (
    <ApplicationsPage
      ...
      headerContent={
        <ModelTrainingProjectSelector getRedirectPath={(ns: string) => `/modelTrainingV1/${ns}`} />
      }
        ...
        project ? undefined : (
          <ModelTrainingLoading
            ...
            onCancel={() => {
              ...
              if (redirectProject) {
                navigate(`/modelTrainingV1/${redirectProject.metadata.name}`);
              }
            }}
          />
        )
